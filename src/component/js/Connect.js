        ...
        <>
            <div className='connect_me'>
                ...
                <div className='connect'>
                    <div className='connect_content'>
                        <div className='cont'>&#x1F4DE; +919945052707</div>
                        <div className='cont'>&#128231;&nbsp;pratheeknayak2153@gmail.com</div>
                        <div className='cont'>&#128204;&nbsp;Mangalore, Karnataka, India</div>
                        <div className="social">
                            ...
                            <div className="face">
                                <a href="https://www.facebook.com/profile.php?id=100091435612255" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                            ...
                            <div className="linkd">
                                <a href="https://www.linkedin.com/in/pratheek-nayak-b-k-93751725a/" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                            ...
                            <div className="github">
                                <a href="https://github.com/NayakPratheek" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
            ...
            <div class="footer">
                <div className='foot1'>
                    ...
                    <h6><span><i>&#169; nayak_pratheek_ | All rights reserved</i></span></h6>
                </div>
                <div className='foot2'>
                    <div className="social">
                        <div className="insta">
